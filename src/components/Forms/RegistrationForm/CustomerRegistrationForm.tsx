...
const CustomerSpecificData=()=>{
    return(
        ...
        <ListItem  style={{ width: "100%", justifyItems: "center" }} ><TextField className={clsx(classes.margin, classes.textField)} required id="standard-required" label="First Name" />
...
<ListItem>
<TextField className={clsx(classes.margin, classes.textField)} required id="standard-required" label="Enter your address" />
